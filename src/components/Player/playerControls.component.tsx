...
import { transferPlayback, userService } from "../../services/user.service";
...
function PlayerControls() {
    ...
    const { data } = useQuery(
        [userService.userDevices.key],
        userService.userDevices.fn
    );
    useEffect(() => {
        updateDevices(data);
    }, [data]);
            ...
            <div className="flex gap-2 items-center">
                ...
                >
                    ...
                    <input
                        ...
                        style={{
                            background: `linear-gradient( to right, ${hovered ? "#1ed760" : "#fff"
